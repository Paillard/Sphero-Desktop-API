...
public class ServerRequestHandler {
     ...
     *                if <code>id</code> is not in the range -1 to
     *                2<sup>32</sup>-1
     */
     ...
     * 
     * @param backup
     *            <code>true</code> if the client requests that the server back
     *            up one directory before changing to the path described by
     *            <code>name</code>; <code>false</code> to apply the request to
     *            the present path
     * 
     * @param create
     *            <code>true</code> if the path should be created if it does not
     *            already exist; <code>false</code> if the path should not be
     *            created if it does not exist and an error code should be
     *            returned
     * 
     * @return a response code defined in <code>ResponseCodes</code> that will
     *         be returned to the client; if an invalid response code is
