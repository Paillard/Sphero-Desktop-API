...
public class LocalDevice {
     ...
     * method will return the same object. This method will never return
     * <code>null</code>.
     * 
     ...
     * 
     * @return the name of the local device; <code>null</code> if the name could
     *         not be retrieved
     */
    ...
    /**
     * Retrieves the <code>DeviceClass</code> object that represents the service
     * classes, major device class, and minor device class of the local device.
     * This method will return <code>null</code> if the service classes, major
     * device class, or minor device class could not be determined.
     * 
     * @return the service classes, major device class, and minor device class
     *         of the local device, or <code>null</code> if the service classes,
     *         major device class or minor device class could not be determined
     * 
     */
     ...
     * ( <code>DiscoveryAgent.GIAC</code>) and LIAC (
     * <code>DiscoveryAgent.LIAC</code>) were defined, but Bluetooth profiles
     * may add additional access codes in the future. To determine what values
     * may be used, check the Bluetooth Assigned Numbers document at <A
     * HREF="http://www.bluetooth.org/assigned-numbers/baseband.htm">
     ...
     * discoverable ( <code>DiscoveryAgent.LIAC</code>) for 1 minute. This is
     ...
     *            <code>DiscoveryAgent.GIAC</code>,
     *            <code>DiscoveryAgent.LIAC</code>,
     *            <code>DiscoveryAgent.NOT_DISCOVERABLE</code> and any value in
     ...
     *                if the <code>mode</code> is not
     *                <code>DiscoveryAgent.GIAC</code>,
     *                <code>DiscoveryAgent.LIAC</code> ,
     *                <code>DiscoveryAgent.NOT_DISCOVERABLE</code>, or in the
     *                range 0x9E8B00 to 0x9E8B3F
     * 
     * @exception BluetoothStateException
     *                if the Bluetooth system is in a state that does not allow
     *                the discoverable mode to be changed
     * 
     */
     ...
     * <TD>The version of the Java API for Bluetooth wireless technology that is
     * supported. For this version it will be set to "1.1.1".</TD>
     * </TR>
     * <TR>
     * <TD>bluetooth.master.switch</TD>
     * <TD>Is master/slave switch allowed? Valid values are either "true" or
     * "false".</TD>
     * </TR>
     * <TR>
     * <TD>bluetooth.sd.attr.retrievable.max</TD>
     * <TD>Maximum number of service attributes to be retrieved per service
     * record. The string will be in Base 10 digits.</TD>
     * </TR>
     * <TR>
     * <TD>bluetooth.connected.devices.max</TD>
     * <TD>The maximum number of connected devices supported. This number may be
     * greater than 7 if the implementation handles parked connections. The
     * string will be in Base 10 digits.</TD>
     * </TR>
     * <TR>
     * <TD>bluetooth.l2cap.receiveMTU.max</TD>
     * <TD>The maximum ReceiveMTU size in bytes supported in L2CAP. The string
     * will be in Base 10 digits, e.g. "32".</TD>
     * </TR>
     * <TR>
     * <TD>bluetooth.sd.trans.max</TD>
     * <TD>Maximum number of concurrent service discovery transactions. The
     * string will be in Base 10 digits.</TD>
     * </TR>
     * <TR>
     * <TD>bluetooth.connected.inquiry.scan</TD>
     * <TD>Is Inquiry scanning allowed during connection? Valid values are
     * either "true" or "false".</TD>
     * </TR>
     * <TR>
     * <TD>bluetooth.connected.page.scan</TD>
     * <TD>Is Page scanning allowed during connection? Valid values are either
     * "true" or "false".</TD>
     * </TR>
     * <TR>
     * <TD>bluetooth.connected.inquiry</TD>
     * <TD>Is Inquiry allowed during a connection? Valid values are either
     * "true" or "false".</TD>
     * </TR>
     * <TR>
     * <TD>bluetooth.connected.page</TD>
     * <TD>Is paging allowed during a connection? In other words, can a
     * connection be established to one device if it is already connected to
     ...
     * 
     * @return the value of the property specified; <code>null</code> if the
     *         <code>property</code> is not defined
     */
     ...
     * <code>DiscoveryAgent.NOT_DISCOVERABLE</code>, or a value in the range
     ...
     * address will never be <code>null</code>. The Bluetooth address will be 12
     ...
     * <code>btl2cap</code>, or <code>btgoep</code> notifier. In the case of a
     * run-before-connect service, the service record returned by
     * <code>getRecord()</code> was created by the same call to
     * <code>Connector.open()</code> that created the <code>notifier</code>.
     * 
     * <p>
     ...
     * removed, then the <code>ServiceRecord</code> returned by
     * <code>getRecord()</code> was created by the same call to
     ...
     * In this case, the <code>getRecord()</code> method must return a
     ...
     * in the <code>ServiceRecord</code> returned by <code>getRecord()</code>.
     * 
     * <p>
     * Two invocations of this method with the same <code>notifier</code>
     ...
     * 
     * @exception IllegalArgumentException
     *                if <code>notifier</code> is closed, or if
     *                <code>notifier</code> does not implement one of the
     ...
     *                notifier, e.g., a <code>StreamConnectionNotifier</code>
     *                created with a scheme other than <code>btspp</code>.
     * 
     ...
     * <code>ServiceRecord</code> parameter. Updating is possible only if
     * <code>srvRecord</code> was obtained using the <code>getRecord()</code>
     * method. The service record in the SDDB is modified to have the same
     * service attributes with the same contents as <code>srvRecord</code>.
     * 
     * <p>
     * 
     * If <code>srvRecord</code> was obtained from the SDDB of a remote device
     ...
     * <P>
     * 
     * If the <code>srvRecord</code> parameter is a <code>btspp</code> service
     ...
     * attributes for a <code>btspp</code> service record, must be present in
     * <code>srvRecord</code>.
     ...
     * <P>
     * 
     * If the <code>srvRecord</code> parameter is a <code>btl2cap</code> service
     * record, then before the SDDB is changed the following checks are
     * performed. If any of these checks fail, then an
     * <code>IllegalArgumentException</code> is thrown.
     * <UL>
     ...
     * <LI><code>srvRecord</code> must not have changed the PSM value from the
     * PSM value that is currently in the SDDB version of this service record.
     * </UL>
     * 
     * <P>
     * 
     * If the <code>srvRecord</code> parameter is a <code>btgoep</code> service
     * record, then before the SDDB is changed the following checks are
     * performed. If any of these checks fail, then an
     * <code>IllegalArgumentException</code> is thrown.
     * <UL>
     ...
     * <code>srvRecord</code> is a completely valid service record. It is the
     * responsibility of the application to ensure that <code>srvRecord</code>
     * follows all of the applicable syntactic and semantic rules for service
     * record correctness.
     * 
     * <P>
     * 
     * If there is currently no SDDB version of the <code>srvRecord</code>
     ...
     * 
     * @exception NullPointerException
     *                if <code>srvRecord</code> is <code>null</code>
     * 
     * @exception IllegalArgumentException
     *                if the structure of the <code>srvRecord</code> is missing
