...
public class RawMotor extends MacroCommand
{
	 ...
	 */
	public RawMotor( MOTOR_MODE _leftMode, int _leftSpeed, MOTOR_MODE _rightMode, int _rightSpeed, int _delay )
	{
	 ...
	 * @param _rightSpeed The right motor speed (MIN_SPEED - MAX_SPEED)
	 */
	public RawMotor( MOTOR_MODE _leftMode, int _leftSpeed, MOTOR_MODE _rightMode, int _rightSpeed )
	{
		super( MACRO_COMMAND.MAC_RAW_MOTOR );
        this.setMotorModes( _leftMode, _rightMode );
        this.setMotorSpeed( _leftSpeed, _rightSpeed );
	 ...
	 */
	public void setMotorModes( MOTOR_MODE _leftMode, MOTOR_MODE _rightMode )
	{
