...
public interface DBus extends DBusInterface
{
    ...
    */
   interface Peer extends DBusInterface
   {
      void Ping();
   }
   /**
    ...
    */
   interface Introspectable extends DBusInterface
   {
      /**
    ...
    */
   interface Local extends DBusInterface
   {
   ...
   interface Binding
   {
      ...
      interface Tests extends DBusInterface
      {
      ...
      interface TestSignals extends DBusInterface
      {
