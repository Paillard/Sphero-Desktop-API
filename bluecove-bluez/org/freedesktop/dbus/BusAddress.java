...
public class BusAddress
{
   ...
   {
      if (null == address || "".equals(address)) throw new ParseException(getResource("Bus address is blank"), 0);
      if (Debug.debug) Debug.print(Debug.VERBOSE, "Parsing bus address: "+address);
      String[] ss = address.split(":", 2);
      if (ss.length < 2) throw new ParseException(getResource("Bus address is invalid: ")+address, 0);
       type = ss[0];
