...
public abstract class AbstractConnection
{
    ...
    protected final Map<SignalTuple,Vector<DBusSigHandler<? extends DBusSignal>>> handledSignals;
    ...
    protected final LinkedList<Runnable> runnables;
    protected final LinkedList<_workerthread> workers;
    protected FallbackContainer fallbackcontainer;
    protected boolean _run;
    EfficientQueue outgoing;
    final LinkedList<Error> pendingErrors;
    ...
    static {
        ...
        if (Debug.debug) {
            ...
            if (f.exists()) {
                ...
                //TODO : MismatchedQueryAndUpdateOfCollection?
